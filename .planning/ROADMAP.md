...
| 5 | /bf-build | 3/3 | Complete   | 2026-06-15 |
...
- [x] 05-02-PLAN.md — Author bf-build/SKILL.md with 10 sections (frontmatter, @include + fallback, summary, support files, intake, Figma Context Path A, Path B spec parsing, output rules, anti-patterns) + create ~/.claude/skills/bf-build symlink
- [x] 05-03-PLAN.md — Human verify five scenarios (bare invoke, Path A Figma frame, Path B component spec, Path B screen spec inventory gate, Path B composite spec cross-reference auto-read)
